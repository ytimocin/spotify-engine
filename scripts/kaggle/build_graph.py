...
def create_edge_indices(data, mappings):
    ...
    edges[('playlist', 'contains', 'track')] = torch.tensor([playlist_idx, track_idx], dtype=torch.long)
    edges[('track', 'in_playlist', 'playlist')] = torch.tensor([track_idx, playlist_idx], dtype=torch.long)
    ...
    edges[('genre', 'includes_track', 'track')] = torch.tensor([genre_idx, track_idx], dtype=torch.long)
    ...
    edges[('artist', 'performs_genre', 'genre')] = torch.tensor([artist_idx, genre_idx], dtype=torch.long)
    edges[('genre', 'performed_by', 'artist')] = torch.tensor([genre_idx, artist_idx], dtype=torch.long)
